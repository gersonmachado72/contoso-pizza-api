...
public static class PizzaService
{
    ...
    public static void Add(Pizza pizza) { pizza.Id = _nextId++; _pizzas.Add(pizza); }
    public static void Update(Pizza pizza) { var index = _pizzas.FindIndex(p => p.Id == pizza.Id); if (index != -1) _pizzas[index] = pizza; }
    public static void Delete(int id) { var pizza = Get(id); if (pizza != null) _pizzas.Remove(pizza); }
}
